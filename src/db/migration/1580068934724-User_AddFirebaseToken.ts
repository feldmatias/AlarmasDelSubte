...
export class UserAddFirebaseToken1580068934724 implements MigrationInterface {
    name = 'UserAddFirebaseToken1580068934724'

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TABLE "temporary_user" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "username" varchar NOT NULL, "password" varchar NOT NULL, "token" varchar NOT NULL, "firebaseToken" varchar, CONSTRAINT "UQ_78a916df40e02a9deb1c4b75edb" UNIQUE ("username"))`, undefined);
