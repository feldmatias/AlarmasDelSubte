...
export class LastAlarmSent1579984009563 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TABLE "temporary_subway_alarm" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "alarmId" integer, "subwayLine" varchar, "lastAlarmSentStatus" varchar NOT NULL DEFAULT (''), "lastAlarmSentDate" datetime NOT NULL, CONSTRAINT "FK_84fbd8417b3d1c20218cd2003b4" FOREIGN KEY ("subwayLine") REFERENCES "subway" ("line") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_3da504025e9d9f7c990d4c27e53" FOREIGN KEY ("alarmId") REFERENCES "alarm" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`, undefined);
